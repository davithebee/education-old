...
--
-- Host: localhost
-- Czas wygenerowania: 25 Wrz 2020, 07:52
...
--
-- Baza danych: `noworodki_2011`
--

-- --------------------------------------------------------

--
-- Struktura tabeli dla  `mamy`
--

CREATE TABLE IF NOT EXISTS `mamy` (
  `identyfikator matki` int(11) NOT NULL AUTO_INCREMENT,
  `imię` varchar(30) NOT NULL,
  `wiek` int(11) NOT NULL,
  PRIMARY KEY (`identyfikator matki`)
...
INSERT INTO `mamy` (`identyfikator matki`, `imię`, `wiek`) VALUES
(1, 'Agata', 25),
(2, 'Agnieszka', 33),
(3, 'Agnieszka', 23),
(4, 'Aleksandra', 36),
...
--
-- Struktura tabeli dla  `noworodki`
--

CREATE TABLE IF NOT EXISTS `noworodki` (
  `identyfikator` int(11) NOT NULL AUTO_INCREMENT,
  `płeć` enum('c','s') DEFAULT NULL,
  `imię` varchar(30) NOT NULL,
  `data urodzenia` date NOT NULL,
  `waga` int(11) NOT NULL,
  `wzrost` int(11) NOT NULL,
  `identyfikator matki` int(11) DEFAULT NULL,
  PRIMARY KEY (`identyfikator`),
  KEY `identyfikator matki` (`identyfikator matki`)
...
INSERT INTO `noworodki` (`identyfikator`, `płeć`, `imię`, `data urodzenia`, `waga`, `wzrost`, `identyfikator matki`) VALUES
